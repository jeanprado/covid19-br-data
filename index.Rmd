...
**óbitos**: no **`r br_data$deaths_5`º dia desde o 5º óbito**, o Brasil tem **`r th(br_data$total_deaths)` casos confirmados de Covid-19**. para comparação, os **5 países com mais mortes no mundo** tinham, neste período, esse número de óbitos: `r  deaths_countries`.
